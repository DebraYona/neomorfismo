  ...
  return (
    <Row style={{ }}>
      ...
      <Col span={15} style={{ }}>
        ...
        <Containerwallet>
          <ContainerTwinebusiness banco="12385858712312" beneficiario="23123147672312" />
...
interface ConteinerTwinebusinessProps {
  banco: string;
  beneficiario: string;
}

const ContainerTwinebusiness: FC<ConteinerTwinebusinessProps> = ({
