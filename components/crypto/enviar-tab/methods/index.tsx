    ...
    <Wrapper>
      ...
      <Link
        href={{
          ...
          query: { ...query, action: 'send', method: 'exchange' },
        }}
      >
        <a>
      ...
      <Link
        href={{
          pathname: '/cryptomoneda',
          query: { ...query, action: 'send', method: 'card' },
        }}
      >
        <a>
      ...
      <Link
        href={{
          pathname: '/cryptomoneda',
          query: { ...query, action: 'send', method: 'wallet' },
        }}
      >
        <a>
          <Method logo="./tiendaAuto2.svg" name="TIENDAS AUTORIZADAS" />
        </a>
      </Link>
      <Link
        href={{
          pathname: '/cryptomoneda',
          query: { ...query, action: 'send', method: 'criptomonedas' },
        }}
      >
        <a>
          <Method logo="./criptomonedas.svg" name="CUENTA DE CRIPTOMONEDAS" />
        </a>
      </Link>
      <Link
        href={{
          pathname: '/cryptomoneda',
          query: { ...query, action: 'send', method: 'deposito' },
        }}
      >
        <a>
          <Method logo="./deposito.svg" name="DEPOSITO CON SPEI" />
        </a>
      </Link>
    </Wrapper>
  );
