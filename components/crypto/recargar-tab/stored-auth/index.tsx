...
const ContainerInfo: FC = () => {
  return (
    <BodyInfo>
      <ContainerList> 
      <TitleInfo>INFORMACIÓN ADICIONAL</TitleInfo>

        <InfoLi>
          <TextInfoB>
            Deposita a tu cuenta con efectivo<br></br>
            en cualquier OXXO usando tu código.
          </TextInfoB>
        </InfoLi>        
        <InfoLi>
          <TextInfoB>
            Tu código QR es único y será<br></br>
            siempre el mismo.
          </TextInfoB>
        </InfoLi>
        <InfoLi>
          <TextInfoB>
            Dile al cajero que harás un OXXO Pay<br></br>
            y muéstrale tu código QR para que lo<br></br>
            escanee.          
          </TextInfoB>
        </InfoLi>
        <InfoLi>
        <TextInfoB>
        Realiza el pago en efectivo y pide<br></br>
        tu comprobante.
        </TextInfoB>        
        </InfoLi>
        <InfoLi>
        <TextInfoB>
          Puedes depositar hasta $5,000 MXN.
        </TextInfoB></InfoLi>
      </ContainerList>          
    </BodyInfo>
  );
...
const ContainerQrInfo: FC<ContainerQrInfoProps> = ({
  ...
  return (
    <ContainerQr>
      <ImageOxxo src="./Oxxo_Logo.svg" />
      <TextInfoA>Deposita a tu cuenta de Twinbusiness con <br></br>
      efectivo en cualquier oxxo del país, solo<br></br>
